...
const filterGreatAuthors = books.filter((books) => books.sales >1000000);

//console.log(filterGreatAuthors);
const greatAuthors = filterGreatAuthors.map((books) => `${books.author} adalah penulis buku ${books.title} yang sangat hebat!`)
